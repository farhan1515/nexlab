  ...
  theme: {
    extend: {
      colors: {
        ...
        dark: {
          DEFAULT: "#051020", // Deep navy background
          deeper: "#020A14",
          card: "#0D2137",
        },
        navy: {
      ...
      boxShadow: {
        ...
        "glow-amber": "0 0 40px rgba(255, 184, 0, 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      backgroundImage: {
        ...
        "gradient-accent": "linear-gradient(135deg, #00D4AA 0%, #FFB800 100%)",
        "gradient-cta": "linear-gradient(135deg, #00D4AA 0%, #FFB800 50%, #00D4AA 100%)",
        "gradient-navy": "linear-gradient(180deg, #0A2540 0%, #051020 100%)",
      },
    },
  },
